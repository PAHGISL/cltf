# CLTF Numerical Core Implementation Plan
...
- Create `R/DESCRIPTION`: package metadata and dependencies.
- Create `R/LICENSE`: MIT license metadata.
- Create `R/NAMESPACE`: generated by `roxygen2`.
- Create `R/R/cltf.R`: CLTF layer definitions, PDFs, CDFs, convolution and mass fractions.
- Create `R/R/concentration.R`: soil-mass and concentration conversions.
- Create `R/R/simulate.R`: vector time-series simulation.
- Create `R/R/water_balance.R`: infiltration and first-passage inverse.
- Create `R/tests/testthat.R`: package test entry point.
- Create `R/tests/testthat/test-cltf-single-layer.R`: single-layer mathematical tests.
- Create `R/tests/testthat/test-cltf-two-layer.R`: convolution and conservation tests.
- Create `R/tests/testthat/test-concentration.R`: unit-conversion tests.
- Create `R/tests/testthat/test-simulate.R`: limiting-case and time-series tests.
- Create `R/tests/testthat/test-water-balance.R`: water-balance and plateau inverse tests.
- Create `R/README.md`: numerical-core usage and assumptions.
...
- Create: `R/LICENSE`
- Create: `R/R/cltf.R`
- Create: `R/tests/testthat.R`
- Create: `R/tests/testthat/helper-fixtures.R`
...
# Inputs: Tests and package source under cltf.
...
```bash
git add cltf
git commit -m "build: scaffold cltf package"
```
...
**Files:**
- Modify: `R/R/cltf.R`
- Create: `R/tests/testthat/test-cltf-single-layer.R`
...
# Usage: testthat::test_file("R/tests/testthat/test-cltf-single-layer.R")
# Dependencies: testthat, cltf
...
```bash
Rscript -e 'roxygen2::roxygenise("cltf"); testthat::test_local("R", filter = "cltf-single-layer")'
```
...
```bash
git add R/R/cltf.R R/tests/testthat/test-cltf-single-layer.R R/NAMESPACE R/man
...
**Files:**
- Modify: `R/R/cltf.R`
- Create: `R/tests/testthat/test-cltf-two-layer.R`
...
# Outputs: Testthat assertions.
# Usage: testthat::test_file("R/tests/testthat/test-cltf-two-layer.R")
# Dependencies: testthat, cltf
...
```bash
Rscript -e 'roxygen2::roxygenise("cltf"); testthat::test_local("R", filter = "cltf-two-layer")'
```
...
```bash
git add R/R/cltf.R R/tests/testthat/test-cltf-two-layer.R R/NAMESPACE R/man
...
**Files:**
- Create: `R/R/concentration.R`
- Create: `R/tests/testthat/test-concentration.R`
...
# Outputs: Testthat assertions.
# Usage: testthat::test_file("R/tests/testthat/test-concentration.R")
# Dependencies: testthat, cltf
...
```bash
Rscript -e 'roxygen2::roxygenise("cltf"); testthat::test_local("R", filter = "concentration")'
```
...
```bash
git add R/R/concentration.R R/tests/testthat/test-concentration.R R/NAMESPACE R/man
...
**Files:**
- Create: `R/R/simulate.R`
- Create: `R/tests/testthat/test-simulate.R`
...
# Outputs: Testthat assertions.
# Usage: testthat::test_file("R/tests/testthat/test-simulate.R")
# Dependencies: testthat, cltf
...
```bash
Rscript -e 'roxygen2::roxygenise("cltf"); testthat::test_local("R", filter = "simulate")'
```

Expected: FAIL because `simulate_cltf()` does not exist.
...
```bash
git add R/R/simulate.R R/tests/testthat/test-simulate.R R/NAMESPACE R/man
git commit -m "feat: add conservative CLTF time-series simulation"
```

### Task 6: Implement water balance and first-passage inverse

**Files:**
- Create: `R/R/water_balance.R`
- Create: `R/tests/testthat/test-water-balance.R`
...
# Outputs: Testthat assertions.
# Usage: testthat::test_file("R/tests/testthat/test-water-balance.R")
# Dependencies: testthat, cltf
...
```bash
Rscript -e 'roxygen2::roxygenise("cltf"); testthat::test_local("R", filter = "water-balance")'
```
...
```bash
git add R/R/water_balance.R R/tests/testthat/test-water-balance.R R/NAMESPACE R/man
...
**Files:**
- Modify: `R/tests/testthat/test-cltf-two-layer.R`
- Modify: `R/R/cltf.R`

- [ ] **Step 1: Add failing stress tests**

Append to `R/tests/testthat/test-cltf-two-layer.R`:
...
```bash
git add R/R/cltf.R R/tests/testthat/test-cltf-two-layer.R
...
```markdown
- `R/` — reference R package for the verified two-layer CLTF model. The R implementation is developed and validated before equivalent Python updates.
```
...
Expected: `R/NAMESPACE` and `R/man/*.Rd` are current.
...
git commit -m "docs: document the CLTF numerical core"
```
